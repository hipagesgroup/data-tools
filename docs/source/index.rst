...
- Use pre compiled scripts and modules that can be executed from command line (:ref:`.. _etl_package:`.)
- Higher level etl classes, that allow you to build complex data transformations (:ref:`.. _hipages_package:`.)
