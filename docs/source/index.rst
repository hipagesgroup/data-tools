...
- Use pre compiled scripts and modules that can be executed from command line (:ref:`hip\_data\_tools.hipages`.)
- Higher level etl classes, that allow you to build complex data transformations (:ref:`hip\_data\_tools.etl`.)
