...
- Use pre compiled scripts and modules that can be executed from command line (:doc:`/hip\_data\_tools.etl`)
- Higher level etl classes, that allow you to build complex data transformations (:doc:`/hip\_data\_tools.hipages`)
